...
export default function Report() {
  ...
  return (
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 print:bg-white text-left" id="reports-page-wrapper">
      <div className="max-w-7xl mx-auto space-y-8 print:space-y-0">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-200 pb-4 print:hidden">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-cat-yellow text-cat-black font-mono font-bold text-xs uppercase px-4 py-2 hover:bg-cat-black hover:text-white transition-all cursor-pointer shadow active:scale-95"
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start print:grid-cols-1 print:gap-0">
            ...
            <div className="lg:col-span-4 bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm print:hidden">
                ...
                {reports.map((rep) => (
                  <button
                    ...
                    className={`w-full text-left p-4 hover:bg-gray-50 transition-colors flex items-center justify-between cursor-pointer ${
                      selectedReport?.id === rep.id ? 'bg-cat-gray-light border-r-4 border-r-cat-yellow' : ''
                    }`}
                  >
            ...
            <div className="lg:col-span-8 bg-white border border-gray-200 shadow-lg rounded-lg p-6 sm:p-8 print:border-none print:shadow-none print:p-0 print:m-0 relative">
              {selectedReport ? (
                <div id="printable-report-sheet">
                  ...
                  <div className="flex justify-between items-start border-b-2 border-cat-yellow pb-4 mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="border-l border-gray-200 pl-4">
                        <div className="text-[11px] font-mono font-extrabold text-gray-900 uppercase tracking-[0.15em]">{t('systemDiagnosticLog')}</div>
                    ...
                    <div className="text-right font-mono text-xs text-gray-500">
                      <div>REPORT ID: <span className="font-bold text-gray-900">{selectedReport.id}</span></div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs font-mono bg-gray-50 p-4 border border-gray-200 rounded">
                      <div>
                        <span className="text-[10px] text-gray-400 block uppercase tracking-widest font-extrabold mb-0.5">Technician</span>
                        <span className="font-bold text-gray-800">{selectedReport.technician}</span>
                      </div>
                      <div>
                        <span className="text-[10px] text-gray-400 block uppercase tracking-widest font-extrabold mb-0.5">Role</span>
                        <span className="font-bold text-gray-800">{t(selectedReport.role.toLowerCase() || 'operator')}</span>
                      </div>
                      <div>
                        <span className="text-[10px] text-gray-400 block uppercase tracking-widest font-extrabold mb-0.5">Branch</span>
                        <span className="font-bold text-gray-800">{selectedReport.branch}</span>
                      </div>
                      <div>
                      ...
                      <div className="border border-gray-200 rounded overflow-hidden">
                        <table className="w-full text-xs">
                          ...
                          <tbody className="divide-y divide-gray-100 text-gray-700">
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('rpm')}</td>
                            ...
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('fuelRate')}</td>
                            ...
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('fuelInjectionTime')}</td>
                            ...
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('injectionPressure')}</td>
                            ...
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('maf')}</td>
                              <td className="px-4 py-2.5 text-right font-mono font-bold">{selectedReport.inputs.maf}</td>
                              <td className="px-4 py-2.5 font-mono text-gray-400">kg/h</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('map')}</td>
                              <td className="px-4 py-2.5 text-right font-mono font-bold">{selectedReport.inputs.map}</td>
                              <td className="px-4 py-2.5 font-mono text-gray-400">bar</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('deltaP')}</td>
                            ...
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('egt')}</td>
                            ...
                            <tr>
                              <td className="px-4 py-2.5 font-sans font-medium text-gray-700">{t('nox')}</td>
                    ...
                    {/* Signatures */}
                    <div className="grid grid-cols-2 gap-8 pt-10 font-mono text-xs border-t border-gray-100">
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200 flex flex-wrap gap-4 justify-between print:hidden">
                    <button
                      onClick={handleDownloadPdf}
                      className="flex items-center gap-1.5 border border-gray-300 hover:border-cat-yellow text-gray-700 px-4 py-2 font-mono font-bold text-xs uppercase cursor-pointer transition-all active:scale-95"
                      id="download-pdf-btn"
                    >
                    ...
                    <button
                      onClick={handlePrint}
                      className="flex items-center gap-1.5 bg-cat-yellow text-cat-black hover:bg-cat-black hover:text-white font-mono font-bold text-xs uppercase px-6 py-2 shadow border border-cat-yellow cursor-pointer transition-all active:scale-95"
                      id="print-report-btn"
                    >
